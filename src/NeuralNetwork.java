...
public class NeuralNetwork {
    ...
    private String saveDestionation;
...
//    determine search bounds
    public NeuralNetwork(int[] allLayers, double[] searchBounds, String saveDestionation){
        brain = new ArrayList<>();
        networkBias = new double[allLayers.length];
        this.saveDestionation = saveDestionation;
...
//    Used for diagnosing the network, helpful and gives a little more information
    ...
    public void saveBrain(){
        ...
        try(FileWriter fileWriter = new FileWriter(saveDestionation)){
